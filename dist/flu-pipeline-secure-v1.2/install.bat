...
REM Set installation directory (hidden in user profile)
...
echo ============================================================
echo.
echo Workflow installed to: %INSTALL_DIR% (hidden)
...
echo.
echo Note: All files are installed in hidden directory.
echo Your metadata.xlsx should be in your working directory.
echo ============================================================
pause
